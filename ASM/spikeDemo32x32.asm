...
_16.0:         equ  0x4300         ;  binary7/8 representation of 16.00 decimal
...
;            _       _2:REPEAT = _2:#255                ;initialize all input charge rates to the value 6 (for 16x16 SNN)
            _       _2:REPEAT = _2:#1023               ;initialize all input charge rates to the value 6 (for 32x32 SNN)
...
;            _       _2:REPEAT = _2:#31                 ;initialize all input thresholds to the value 2.5 (for 16x16 SNN)
            _       _2:REPEAT = _2:#127                 ;initialize all input thresholds to the value 2.5 (for 32x32 SNN)
...
;            _       _2:*AR1++[1] = _2:#_8.0            ;something around 8.0
            _       _2:*AR1++[1] = _2:#_16.0            ;something around 16.0
            
pushSpikes: 
            _       _4:AR2 = _4:#0                     ;point to first set of weights, rates, thresholds
            _       _4:AR3 = _4:#spikeSrcMem           ;point to input spike train source buffer location
 
;------------- first set of 8 membranes -----------------------------------           
;first pass on first group of 8 inputs on first 8 membranes                                                      
...
;second group of 8 inputs on first 8 membranes                                                      
            ...
            _       _2:REPEAT = _2:#31                 ;input spike train is 32 ticks deep in this example
            ACC      _1:*AR5++[1] = (_1:*AR3++[1], _128:1) ;using only accumulate, push the spike train and 

;third group of 8 inputs on first 8 membranes                                                      
            _       _4:AR4 = _4:#SNNinput              ;use AR4 here instead of AR5 because AR5 is still in use by prev instruction due to pipeline
                                                       ;rewind pointer to first location in SNN spike train target input
                                                       ;so we can add second 8 inputs to first 8 inputs computed previously
                                                       ;AR3 is already pointing to second set of input spikes
                                                       ;AR2 is already pointing to second set of weights, rates and thresholds
            _       _2:REPEAT = _2:#31                 ;input spike train is 32 ticks deep in this example
            ACC      _1:*AR4++[1] = (_1:*AR3++[1], _128:2) ;using only accumulate, push the spike train and 

;fourth group of 8 inputs on first 8 membranes                                                      
            _       _4:AR5 = _4:#SNNinput              ;use AR5 here instead of AR4 because AR4 is still in use by prev instruction due to pipeline
                                                       ;rewind pointer to first location in SNN spike train target input
                                                       ;so we can add second 8 inputs to first 8 inputs computed previously
                                                       ;AR3 is already pointing to second set of input spikes
                                                       ;AR2 is already pointing to second set of weights, rates and thresholds
            _       _2:REPEAT = _2:#31                 ;input spike train is 32 ticks deep in this example
            AA      _1:*AR5++[1] = (_1:*AR3++[1], _128:3) ;using accumulate and activate, push the spike train and 

;------------- second set of 8 membranes -----------------------------------           
;first pass on first group of 8 inputs on second 8 membranes                                                      
            _       _4:AR4 = _4:#SNNinput+32           
            _       _2:REPEAT = _2:#31                 
            _       _1:*AR4++[1] = (_1:*AR3++[1], _128:4) 
                                                       
;second group of 8 inputs on second 8 membranes                                                      
            _       _4:AR5 = _4:#SNNinput+32           
            _       _2:REPEAT = _2:#31                 
            ACC      _1:*AR5++[1] = (_1:*AR3++[1], _128:5)  

;third group of 8 inputs on second 8 membranes                                                      
            _       _4:AR4 = _4:#SNNinput+32           
            _       _2:REPEAT = _2:#31                 
            ACC      _1:*AR4++[1] = (_1:*AR3++[1], _128:6) 
                                                       
;fourth group of 8 inputs on second 8 membranes                                                      
            _       _4:AR5 = _4:#SNNinput+32           
            _       _2:REPEAT = _2:#31                 
            AA      _1:*AR5++[1] = (_1:*AR3++[1], _128:7)  

;------------- third set of 8 membranes -----------------------------------           
;first pass on first group of 8 inputs on third 8 membranes                                                      
            _       _4:AR4 = _4:#SNNinput+64           
            _       _2:REPEAT = _2:#31                 
            _       _1:*AR4++[1] = (_1:*AR3++[1], _128:8) 
                                                       
;second group of 8 inputs on third 8 membranes                                                      
            _       _4:AR5 = _4:#SNNinput+64           
            _       _2:REPEAT = _2:#31                 
            ACC      _1:*AR5++[1] = (_1:*AR3++[1], _128:9)  

;third group of 8 inputs on third 8 membranes                                                      
            _       _4:AR4 = _4:#SNNinput+64           
            _       _2:REPEAT = _2:#31                 
            ACC      _1:*AR4++[1] = (_1:*AR3++[1], _128:10) 
                                                       
;fourth group of 8 inputs on third 8 membranes                                                      
            _       _4:AR5 = _4:#SNNinput+64           
            _       _2:REPEAT = _2:#31                 
            AA      _1:*AR5++[1] = (_1:*AR3++[1], _128:11)  

;------------- fourth set of 8 membranes -----------------------------------           
;first pass on first group of 8 inputs on forth 8 membranes                                                      
            _       _4:AR4 = _4:#SNNinput+96           
            _       _2:REPEAT = _2:#31                 
            _       _1:*AR4++[1] = (_1:*AR3++[1], _128:12) 
                                                       
;second group of 8 inputs on forth 8 membranes                                                      
            _       _4:AR5 = _4:#SNNinput+96           
            _       _2:REPEAT = _2:#31                 
            ACC      _1:*AR5++[1] = (_1:*AR3++[1], _128:13)  

;third group of 8 inputs on forth 8 membranes                                                      
            _       _4:AR4 = _4:#SNNinput+96           
            _       _2:REPEAT = _2:#31                 
            ACC      _1:*AR4++[1] = (_1:*AR3++[1], _128:14) 
                                                       
;fourth group of 8 inputs on forth 8 membranes                                                      
            _       _4:AR5 = _4:#SNNinput+96           
            _       _2:REPEAT = _2:#31                 
            AA      _1:*AR5++[1] = (_1:*AR3++[1], _128:15)  
