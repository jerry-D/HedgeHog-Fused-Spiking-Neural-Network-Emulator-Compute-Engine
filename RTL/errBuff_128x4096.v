//errBuff_128x4096.v     128bits (16 bytes) wide by 4096 deep
//
...
module errBuff_128x4096(      //captures all the differences of all the sums and thresholds in a layer every clock cycle
    CLK,
    wren,
    wraddrs,
    wrdata,
...
ultraRAMx72_TDP #(.ADDRS_WIDTH(12)) 
    ...
    .rdaddrsB(groupSel   ),
    .rddataA (          ),
    .rddataB (errAmounts[127:64])
    );        


always @(*)
    (* parallel *) case(wordSel_q1)
        6'd0  : rddata = errAmounts[15:0   ];
        6'd1  : rddata = errAmounts[31:16  ];
        6'd2  : rddata = errAmounts[47:32  ];
        6'd3  : rddata = errAmounts[63:48  ];
        6'd4  : rddata = errAmounts[79:64  ];
        6'd5  : rddata = errAmounts[95:80  ];
        6'd6  : rddata = errAmounts[111:96 ];
        6'd7  : rddata = errAmounts[127:112];
    endcase
