...
module decCharToBinHalfSystFractH8 (
    CLK,
    RESET,
    biasedExp,
    Weight,
...
wire GTE8;
wire [23:0] Bin7;
assign Bin8Test = PartBin - Weight;  //compare fraction input sum with looked-up weight "Weight" to see if input sum is >= looked up weight
assign GTE8 = ~Bin8Test[24];   
assign Bin7 = GTE8 ? Bin8Test[23:0] : PartBin;
...
assign GTE7 = ~Bin7Test[24]; 
assign Bin6 = GTE7 ? Bin7Test[23:0] : Bin7;
assign d7 = GTE7 && |Bin7;
...
assign GTE6 = ~Bin6Test[24]; 
assign Bin5 = GTE6 ? Bin6Test[23:0] : Bin6;
assign d6 = GTE6 && |Bin6;
...
assign GTE5 = ~Bin5Test[24]; 
assign Bin4 = GTE5 ? Bin5Test[23:0] : Bin5_q3;
...
assign GTE4 = ~Bin4Test[24]; 
assign Bin3 = GTE4 ? Bin4Test[23:0] : Bin4;
assign d4 = GTE4 && |Bin4;
...
assign GTE3 = ~Bin3Test[24]; 
assign Bin2 = GTE3 ? Bin3Test[23:0] : Bin3;
assign d3 = GTE3 && |Bin3;
...
assign GTE2 = ~Bin2Test[24]; 
assign Bin1 = GTE2 ? Bin2Test[23:0] : Bin2_q4;
...
assign GTE1 = ~Bin1Test[24]; 
assign Bin0 = GTE1 ? Bin1Test[23:0] : Bin1;
assign d1 = GTE1 && |Bin1;
...
assign GTE0 = ~Bin0Test[24]; 
assign BinG = GTE0 ? Bin0Test[23:0] : Bin0;
assign d0 = GTE0 && |Bin0;
...
assign GTE_G = ~BinGTest[24]; 
assign BinR = GTE_G ? BinGTest[23:0] : BinG;
assign G = GTE_G && |BinG;
...
assign GTE_R = ~BinRTest[24]; 
assign BinS = GTE_R ? BinRTest[23:0] : BinR;
assign R = GTE_R && |BinR;
